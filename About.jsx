...
const About = () => {
  const peopleInfo =[
    {"name": "Mollie Ross","position": "Founder & CEO"},
    {"name": "Jennifer Page","position": "Chef Executive"},
    {"name": "Kate Glover","position": "Doctor"},
    {"name": "Lilly Fry","position": "Trainer"}
  ]
