            ...
            <div className="col-lg-8 col-md-12">
                <div className="row">
                    <div className="col-md-4 mb-5">
                        ...
                        <p><i className="fa fa-map-marker-alt mr-2"></i>123 Street, Gift City, IN</p>
                    ...
                    <div className="col-md-4 mb-5">
                        ...
                        <form action="" onSubmit={handleSubmit(SendData)}>
                            ...
                            <div className="form-group">
                                <input type="email" className="form-control border-0" placeholder="Your Email" name="email"
        ...
        <div className="row">
            <div className="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p className="m-0 text-white">
                    ...
                    <a className="text-white font-weight-bold" href="#">Chetan</a>
                </p>
            </div>
